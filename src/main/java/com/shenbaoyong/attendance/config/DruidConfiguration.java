...
public class DruidConfiguration {
    ...
    public String getSTAT_MEGERSQL() {
        return STAT_MEGERSQL;
    }

    public String getSTAT_SLOWSQLMILLS() {
        return STAT_SLOWSQLMILLS;
    }

    public String getSTAT_LOGSLOWSQL() {
        return STAT_LOGSLOWSQL;
    }
